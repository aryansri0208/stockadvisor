...
start_date = st.date_input("Start Date", datetime(2022, 1, 1), min_value=min_date, max_value=max_date)
        ...
        with st.spinner("Analyzing stock..."):
            try:
                ...
                response = requests.get(
                    f"http://localhost:8000/analyze_stocks/",
                    params={
                        "stock_tickers": stock_ticker,
                        "correlation_tickers": correlation_tickers,
                ...
                if response.status_code == 200:
                    ...
                    error_msg = "Error analyzing stock"
                    try:
